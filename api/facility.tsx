    ...
    return axios
        .get(baseUrl, {
            ...
            params: {
                ...
                // we are fetching all facilities at once because we dont have a long list of facilities
                // ...(page && {page: page}),

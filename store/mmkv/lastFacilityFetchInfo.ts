...
interface LastFacilityFetchInfoStore {
...
export const lastFacilityFetchInfoStore = create<LastFacilityFetchInfoStore>()(
    persist(
        (set) => ({
            lastFetchTime: null,
            wasSuccess: null,
        ...
        {
            name: 'last-facility-fetch-info', // Storage key for MMKV
